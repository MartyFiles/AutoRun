...
### <img width="128px" src="https://i.ibb.co/pjxjrs4Z/2.png" /> 
<strong>AutoRun</strong> — удобный менеджер автозагрузки!
...
### ⚙️ Что он умеет?
Работать с задачами автозагрузки из:
- Реестра
- Папки Startup
- Планировщика задач
- Служб
...
### 💸 Он бесплатный?
Да, версия **1.0 полностью бесплатна**.
...
Утилита **AutoRun 2.0** доступна подписчикам **[MartyPlus](https://t.me/martyfiles/1146)**.
